...
<v-form>
        <v-col>
          ...
          <v-text-field label="Hours" placeholder="3" v-model="course.hours" type="text" id="courseHours"/>
          <v-text-field label="Level" placeholder="2000" v-model="course.level" type="text" id="courseLevel"/>

      ...
      <v-container>
         <v-row>
            <v-col>
               ...
               <H1 style="color: white" v-else>Please login </H1>
                     ...
                     <div class="row">
                        ...
                        <div v-if="getAuth() > 1" class="col col-4">
                           <div  class="v-card v-sheet theme--light" style="cursor: grab"  v-on:click.prevent="goToStudents()">
                              <v-img style="margin-left: 22%" max-width="200" max-height="200" src="@/assets/student.png" />
                        ...
                        <div v-if="getAuth() > 1" class="col col-4">
                           <div v-if="getAuth() > 1" class="v-card v-sheet theme--light" style="cursor: grab" v-on:click.prevent="goToAdvisors()">
                              <v-img style="margin-left: 22%" max-width="200" max-height="200" src="@/assets/teacher.png" />
                        ...
                        <div class="col col-4">
                           <div v-if="getAuth() > 0" class="v-card v-sheet theme--light" style="cursor: grab" v-on:click.prevent="goToCourses()">
                              <v-img style="margin-left: 22%" max-width="200" max-height="200" src="@/assets/course.png" />
                        ...
                        <div class="col col-4">
                           <div v-if="getAuth() > 0" class="v-card v-sheet theme--light" style="cursor: grab" v-on:click.prevent="goToDegrees()">
                              <v-img style="margin-left: 22%"  max-width="200" max-height="200" src="@/assets/degree.png" />
                        ...
                        <div class="col col-4">
                           <div v-if="getAuth() > 0" class="v-card v-sheet theme--light" style="cursor: grab" v-on:click.prevent="goToSemesters()">
                              <v-img style="margin-left: 22%" max-width="200" max-height="200" src="@/assets/semester.png" />
                              <H2 style="text-align: center"> Semesters </H2>
                           </div>
                        </div>
                        <div v-if="getAuth() == 1" class="col col-4"/>
                        <div class="col col-4">
                           <div v-if="getAuth() == 0" class="v-card v-sheet theme--light" style="cursor: grab" v-on:click.prevent="goToLogin()">
                              <v-img style="margin-left: 25%" max-width="200" max-height="200" src="@/assets/login.png" />
                              <H2 style="text-align: center"> Login </H2>
                           </div>
                           <div v-else class="v-card v-sheet theme--light" style="cursor: grab" v-on:click.prevent="goToLogin()">
                              <v-img style="margin-left: 25%" max-width="200" max-height="200" src="@/assets/logout.png" />

<template>
<div>
<H1 style="background-color: #811429; color:#f2f2f2">Degree Add</H1>

<v-form>
        <v-col>
            <v-text-field label="Department" placeholder="CMCS" v-model="degree.dept" type="text" id="dept"/>
...
export default {
  ...
  methods: {
    addDegree() {
        ...
        courseServices.addDegree(this.degree)
        .then(() => {
